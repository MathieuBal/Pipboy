...
État de la source au 21 septembre 2026 : l’API du wiki répond HTTP 403 depuis GitHub Actions. L’indexation massive ne peut donc pas être considérée opérationnelle ; la publication utilise la sélection de 25 liens vérifiés via les pages de fichiers du wiki. Les centaines d’autres enregistrements référencés par le wiki ne sont pas inclus automatiquement tant que cet accès n’est pas rétabli.
